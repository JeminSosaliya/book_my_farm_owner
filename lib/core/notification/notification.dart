...
class NotificationUtils {
  ...
  String channelId = "farm_app_owner_channel";
  String channelName = "farm_app_owner";
  String channelDes = "farm_app_owner_channel_des";
    ...
    if (settings.authorizationStatus == AuthorizationStatus.authorized ||
      ...
      FirebaseMessaging.instance.getToken().then((String? token) async {
        ...
        if (token != null) {
          ...
          log("FCM Token saved to preferences: $token");
        }
      });
    } else {
      if (kDebugMode) {
